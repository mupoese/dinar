...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Dinar " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"dinar.one", "dnsseed.dinar.one"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"dinar.one", "testnet-seed.dinar.one"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Dinar is probably already running."), addrBind.ToString().c_str());
        else
